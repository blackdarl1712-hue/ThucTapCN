...
<head>
    <meta charset="utf-8">
    <title>Truyện Tiên Hiệp | StoryReview </title>
    ...
    <style>
        ...
        .btn-light-pink {
            ...
            color: #212529 !important; /* Màu chữ đen để dễ đọc */
        }
        .border-red { border-color: #DC3545 !important; }
        .border-light-pink { border-color: #FFB6C1 !important; }
        /* Đặt lại màu cho các thành phần dùng màu cũ */
        .navbar-nav .nav-link.active, .navbar-nav .nav-link:hover, .dropdown-menu .dropdown-item.active {
            color: #DC3545 !important; /* Đổi màu active thành đỏ */
        }
        /* Thay thế các màu xanh lá cây (success) bằng màu đỏ (danger) */
...
<body class="bg-white text-dark">
    ...
    <div class="container-fluid px-5 py-4 d-none d-lg-block bg-white border-bottom border-light-pink">
            ...
            <div class="col-md-6 text-center">
                <div class="position-relative ps-4">
                    <div class="d-flex border border-danger rounded-pill">
                        <input class="form-control border-0 rounded-pill w-100 py-3 bg-light text-dark" type="text"
            ...
            <div class="col-md-3 text-center text-lg-end">
                <div class="d-inline-flex align-items-center">
                    <a href="#" class="text-danger d-flex align-items-center justify-content-center me-3"
                        title="Truyện Yêu Thích"><span class="rounded-circle btn-md-square border border-light-pink"><i
                                class="fas fa-heart"></i></span></a>
                    <a href="#" class="text-danger d-flex align-items-center justify-content-center"
                        title="Tài Khoản"><span class="rounded-circle btn-md-square border border-light-pink"><i
                                ...
                                <div class="dropdown-menu bg-light-pink border-0 rounded-0 m-0">
                                    <div class="d-flex p-2">
                                        <div class="col-6">
                                            ...
                                            <a href="{{ route('tienhiep') }}" class="dropdown-item active text-danger">Tiên Hiệp</a>
    ...
    <div class="container-fluid bg-light-pink p-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-3 text-danger mb-4">Truyện Thể Loại Tiên Hiệp</h1>
            <p class="text-dark fs-5">Tổng hợp các bài đánh giá về những bộ truyện tu tiên, phi thăng, kiếm hiệp kỳ ảo hấp dẫn nhất.</p>
            </div>
    </div>
            ...
            <div class="tab-class">
                <div class="row g-4 mb-5">
                    <div class="col-12 text-center wow fadeIn" data-wow-delay="0.1s">
                        <h2 class="text-danger">Tuyển Chọn Truyện Tiên Hiệp Đặc Sắc</h2>
                        </div>
                </div>
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-white border border-danger" data-wow-delay="0.1s">
                                    <div class="product-item-inner border-0 rounded">
                                        <div class="product-item-inner-item">
                                            <img src="{{ asset('img/pham_nhan_tu_tien.png') }}" class="img-fluid w-100 rounded-top"
                                                alt="Bìa Truyện">
                                            <div class="product-new bg-light-pink text-dark">Kinh Điển</div>
                                            <div class="product-details">
                                                <a href="#"><i class="fa fa-eye fa-1x text-danger"></i></a>
                                                </div>
                                        </div>
                                        <div class="text-center rounded-bottom p-4 bg-light-pink">
                                            <a href="#" class="d-block mb-2 text-danger">Tiên Hiệp</a>
                                            <a href="#" class="d-block h4 text-dark">Phàm Nhân Tu Tiên <br> (Cổ Điển)</a>
                                            <span class="me-2 fs-5 text-dark">Vọng Ngữ</span>
                                            <span class="text-danger fs-5">⭐ 9.8/10</span>
                                            </div>
                                    </div>
                                    <div
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-white border border-danger" data-wow-delay="0.3s">
                                    <div class="product-item-inner border-0 rounded">
                                        <div class="product-item-inner-item">
                                            <img src="{{ asset('img/nhat_niem.png') }}" class="img-fluid w-100 rounded-top"
                                                alt="Bìa Truyện">
                                            <div class="product-sale bg-light-pink text-dark">HOT</div>
                                            <div class="product-details">
                                                <a href="#"><i class="fa fa-eye fa-1x text-danger"></i></a>
                                            </div>
                                        </div>
                                        <div class="text-center rounded-bottom p-4 bg-light-pink">
                                            <a href="#" class="d-block mb-2 text-danger">Tiên Hiệp</a>
                                            <a href="#" class="d-block h4 text-dark">Nhất Niệm Vĩnh Hằng <br> (Tu Chân Hài Hước)</a>
                                            <span class="me-2 fs-5 text-dark">Nhĩ Căn</span>
                                            <span class="text-danger fs-5">⭐ 9.3/10</span>
                                        </div>
                                    </div>
                                    <div
                                        class="product-item-add border border-top-0 border-danger rounded-bottom  text-center p-4 pt-0">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-white border border-danger" data-wow-delay="0.5s">
                                    <div class="product-item-inner border-0 rounded">
                                        <div class="product-item-inner-item">
                                            <img src="{{ asset('img/tran_yeu.png') }}" class="img-fluid w-100 rounded-top"
                                                alt="Bìa Truyện">
                                            <div class="product-details">
                                                <a href="#"><i class="fa fa-eye fa-1x text-danger"></i></a>
                                            </div>
                                        ...
                                        <div class="text-center rounded-bottom p-4 bg-light-pink">
                                            <a href="#" class="d-block mb-2 text-danger">Tiên Hiệp</a>
                                            <a href="#" class="d-block h4 text-dark">Trấn Yêu Bảo Tháp <br> (Kỳ Huyễn)</a>
                                            <span class="me-2 fs-5 text-dark">Nhân Gian Thảo</span>
                                            <span class="text-danger fs-5">⭐ 8.7/10</span>
                                        </div>
                                    </div>
                                    <div
                                        class="product-item-add border border-top-0 border-danger rounded-bottom  text-center p-4 pt-0">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp bg-white border border-danger" data-wow-delay="0.7s">
                                    <div class="product-item-inner border-0 rounded">
                                        <div class="product-item-inner-item">
                                            <img src="{{ asset('img/gia_thien.png') }}" class="img-fluid w-100 rounded-top"
                                                alt="Bìa Truyện">
                                            <div class="product-new bg-light-pink text-dark">Cổ</div>
                                            <div class="product-details">
                                                <a href="#"><i class="fa fa-eye fa-1x text-danger"></i></a>
                                            </div>
                                        </div>
                                        <div class="text-center rounded-bottom p-4 bg-light-pink">
                                            <a href="#" class="d-block mb-2 text-danger">Tiên Hiệp</a>
                                            <a href="#" class="d-block h4 text-dark">Già Thiên <br> (Huyền Huyễn)</a>
                                            <span class="me-2 fs-5 text-dark">Thần Đông</span>
    ...
    <div class="container-fluid py-5 bg-light-pink">
        <div class="container py-5">
            <div class="row g-4">
                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                    <a href="#" class="d-flex align-items-center justify-content-between bg-danger rounded p-5">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="text-white">Tổng hợp các bài Review truyện nổi bật nhất</h4>
                                <h1 class="text-dark display-3 mb-0">TUYỂN CHỌN ĐẶC BIỆT</h1>
                                </div>
                        </div>
                        <div class="text-end">
                            <p class="text-white mb-2">Đừng bỏ lỡ!</p>
            ...
            <div class="row g-2">
                <div class="col-md-6 col-lg-6 col-xl-6">
                    <div class="footer-item">
                        ...
                        <p class="text-white">Nền tảng cung cấp các bài đánh giá truyện chữ chuyên sâu và khách quan nhất.</p>
                ...
                <div class="col-md-6 col-lg-6 col-xl-6">
                    <div class="footer-item">
                        ...
                        <p class="text-white">Nhận các bài review truyện mới nhất qua email.</p>
